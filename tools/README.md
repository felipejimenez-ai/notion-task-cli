...
- `notion_task_manager.py`: CRUD operations for Notion tasks (create, read, update, delete, sync). Primary tool.
...
Moved to `.archive/` — kept for reference but no longer part of the main workflow:
